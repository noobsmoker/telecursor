...
class CursorTracker {
  constructor(config = {}) {
    this.config = {
      sampleRate: config.sampleRate || 50,      // Hz - 50Hz default
      maxSessionDuration: config.maxSessionDuration || 600000, // 10 minutes
      minSessionDuration: config.minSessionDuration || 5000,   // 5 seconds
    ...
    // Physics calculation
    this.velocityWindowSize = 5;  // samples for smoothing
